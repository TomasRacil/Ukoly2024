...
class Knihovna:
    ...
    def vyhledej_knihu(self, klicova_slovo: str = ""):
        return [k for k in self.knihy if klicova_slovo.lower() in k._nazev.lower()]
    ...
    def vyhledej_ctenare(self, klicova_slovo: str = ""):
        return [c for c in self.ctenari if klicova_slovo.lower() in c._jmeno.lower()]
