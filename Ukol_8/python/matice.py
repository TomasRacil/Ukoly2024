...
class Matice:
    ...
    def __add__(self, other: Matice) -> Matice:
        ...
        if self.n != other.n or self.m != other.m:
            raise ValueError("Matice musí mít stejné rozměry pro součet.")
        
        return Matice(self.n, self.m, [
    ...
    def transpozice(self) -> Matice:
        ...
        return Matice(self.m, self.n, [
            [self.data[i][j] for i in range(self.n)]
